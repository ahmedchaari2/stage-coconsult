...
// Fait confiance aux headers X-User-Id/X-User-Role posés par la Gateway (JWT déjà validé, cookie
@Component
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // l'AuthenticationEntryPoint (voir SecurityConfig) — signe qu'on a contourné la Gateway.
        ...
        // Bloque un compte désactivé même si la Gateway l'a laissé passer (JWT émis avant
