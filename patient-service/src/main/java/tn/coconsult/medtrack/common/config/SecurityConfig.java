...
// Pas de CSRF ni de cookie ici : on ne fait confiance qu'aux headers posés par la Gateway
// (voir JwtAuthFilter). L'auth et les JWT sont gérés côté user-service.
@Configuration
